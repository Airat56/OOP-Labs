...
int main() {
...

    {
        ...
        printf("Использование методов объектов\n");
        Point *p = new Point;
        p->set(5, 10);
        p->print();
        p->move(4, 7);
    ...
    {
        printf("Копирование объекта в объект того же самого класса\n");
        Point p(4, 20);
        Point p2;
        p2 = p;
        p2.print();
    ...
    {
        printf("Копирование указателя в указатель того же самого класса\n");
    ...
    {
        printf("В чем разница, если объект класса А хранит указатель на объект класса В...\n");
        Section s;
    ...
    {
        printf("...или прямо объект класса В\n");
        Circle c;
        Circle c2(5, 20, 4);
    }
    printf("----------------------------------------------------------------------\n");
